        ...
        return (
            <div className="relative w-full h-full p-5 px-10 flex flex-col gap-5">
                ...
                <div className="flex w-full gap-5">
                    ...
                    <DetailsProduct selectProduct={selectProduct} previewProduct={previewProduct} setPreviewProduct={setPreviewProduct} setShowPackForm={setShowPackForm} setProduct={setProduct}/>
                ...
                <div className={`${!showPackForm ? 'hidden' : 'flex'} absolute z-40 top-0 left-0 w-full h-full`}>
                    <AddPackForm setShowPackForm={setShowPackForm} product={product}/>
                </div>
            </div>
        )
    }