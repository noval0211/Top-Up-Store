            ...
            <div className="w-full h-screen flex pt-24 gap-10 justify-center ">
                ...
                <div className="w-170 h-fit flex flex-col gap-5">
                    <div className="flex flex-col gap-2">
                        ...
                        <p className=" px-5 text-xs opacity-60 ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel similique consectetur hic veritatis reiciendis dolore, explicabo harum iure aliquid doloremque ducimus ullam adipisci omnis nisi, fugit incidunt, consequuntur laudantium magni.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="p-3 flex flex-wrap gap-2">
                            <li className="w-50 px-2 p-1 text-sm wrap-break-word outline-white outline-2 rounded-md">A</li>
                            <li className="w-50 px-2 p-1 text-sm wrap-break-word outline-white outline-2 rounded-md">A</li>
                            <li className="w-50 px-2 p-1 text-sm wrap-break-word outline-white outline-2 rounded-md">A</li>
                            <li className="w-50 px-2 p-1 text-sm wrap-break-word outline-white outline-2 rounded-md">A</li>
                            <li className="w-50 px-2 p-1 text-sm wrap-break-word outline-white outline-2 rounded-md">A</li>
