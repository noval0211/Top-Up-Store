...
export default function Product({ params }) {
    ...
    return (
        <div className="text-[var(--light-color)]">
            ...
            <div className="w-full h-screen flex pt-24 gap-10 px-20">
                <div className="w-1/3 h-fit flex flex-col gap-5">
                    ...
                    <div className="bg-white w-70 h-90 rounded-xl">
                        <Image src={`data:image/*;base64,${productData.image}`}
                            width={100}
                            height={100}
                            alt="items-image"
                ...
                <div className="w-2/3 h-fit flex flex-col gap-5">
                    ...
                    <div>
                        ...
                        <ul className="p-3 flex flex-wrap gap-2">
                            ...
                            {productData.productPacks.map((pack) => (
                                <li 
                                key={pack.id}
                                className="w-50 px-2 p-1 text-[var(--light-color)] text-sm wrap-break-word outline-[var(--light-color)] outline-2 rounded-md">
                                    {pack.name}
                                </li>
                    ...
                    <div>
                        ...
                        <ul className="hidden p-3 flex flex-wrap gap-2">
